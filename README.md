...
The final task in this section involved finding all menu items for which more than two orders have been placed. This was achieved by creating a subquery that listed the menu names from the Menu table for any order quantity with a sum greater than 2.
```
SELECT m.ItemName
	FROM Menu AS m
	WHERE m.MenuID = ANY (
...
![Data Preparation](https://github.com/Abdullatif081/META-Database-Engineering-capstone/assets/82438183/6f6763a4-88a4-44aa-8c83-65f3eff1b629)

### Task 2: Data Visualization
- Created a bar chart titled "Customers Sales" to display customers' sales, filtered for sales with at least $70.
![Sales](https://github.com/Abdullatif081/META-Database-Engineering-capstone/assets/82438183/c997600b-1843-43ac-8a15-ad133d948a20)

- Developed a line chart named "Profit Chart" to show the sales trend from 2019 to 2022.
![Profit](https://github.com/Abdullatif081/META-Database-Engineering-capstone/assets/82438183/0d137454-c9c5-42fe-a689-060c38332f10)

- Generated a bubble chart titled "Sales Bubble Chart" to visualize sales for all customers.
![Bubble Chart](https://github.com/Abdullatif081/META-Database-Engineering-capstone/assets/82438183/0ba3d175-02b4-492b-bed3-981fc8381d20)
...
![Cuisine Sales](https://github.com/Abdullatif081/META-Database-Engineering-capstone/assets/82438183/71d4315d-a236-4828-a34e-824fa11b17f1)
...
![Dashboard](https://github.com/Abdullatif081/META-Database-Engineering-capstone/assets/82438183/f67dbead-5103-44ae-b66b-dbe3e63863a6)
